(ns datomic-course.course6.db.produto
  (:use clojure.pprint)
  (:require [datomic.api :as d]
            [datomic-course.course6.model :as model]
            [datomic-course.course6.db.entidade :as db.entidade]
            [schema.core :as s]
            [clojure.set :as cset]))
...
; Sometimes is important to search by number before search by string, this will make the search faster
